...
Public Class HomePage
    ...
    Private Sub Explorer1_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        'TODO: This line of code loads data into the 'Tech_Army_MIS_databaseDataSet.Church_Member_Finances' table. You can move, or remove it, as needed.
        Me.Church_Member_FinancesTableAdapter.Fill(Me.Tech_Army_MIS_databaseDataSet.Church_Member_Finances)
        'TODO: This line of code loads data into the 'Tech_Army_MIS_databaseDataSet.Church_Members' table. You can move, or remove it, as needed.
        Me.Church_MembersTableAdapter.Fill(Me.Tech_Army_MIS_databaseDataSet.Church_Members)
        'Set up the UI
    ...
    Private Sub Church_MembersBindingNavigatorSaveItem_Click(sender As Object, e As EventArgs) Handles Church_MembersBindingNavigatorSaveItem.Click
        Me.Validate()
        Me.Church_MembersBindingSource.EndEdit()
